...
Vue.component('passport-clients', __webpack_require__(42));
...
var update = __webpack_require__(5)("32415d8c", content, false);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(5)("74be660a", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(5)("1e6af5a7", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
                      ...
                      _c(
                        ...
                        [
                          _c(
                            "a",
                            {
                              staticClass: "btn btn-default btn-sm action-link",
                              on: {
                                click: function($event) {
                                  _vm.revoke(token)
                                }
        ...
        _c("div", { staticClass: "modal-dialog" }, [
          _c("div", { staticClass: "modal-content" }, [
            ...
            _c("div", { staticClass: "modal-body" }, [
              _c("p", [
                _vm._v(
                  "\n                        Aquí está su nuevo token de acceso personal. Esta es la única vez que se mostrará así que no lo pierdas!\n                        Ahora puede usar este token para hacer solicitudes a la API.\n                    "
                )
              ]),
              _vm._v(" "),
