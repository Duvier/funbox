          ...
          <div class="card card-data-tables product-table-wrapper">
            ...
            <div class="card-body p-0">
              ...
              <div class="table-responsive">
                <table id="tbl-users" class="mdl-data-table product-table m-t-30" cellspacing="0" width="100%">
                  <thead>
                    <tr>
                      <th class="col-xs-1"></th>
                      <th class="col-xs-2">Nombre</th>
                      <th class="col-xs-2">Correo</th>
                      <th data-orderable="false" class="col-xs-1">Documento</th>
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-xs-12 col-sm-6">
            ...
            <div class="form-group" :class="{'has-error is-focused': formErrors.password_confirmation}">
              <div class="input-group">
                <span class="input-group-addon"><i class="zmdi zmdi-key"></i></span>
                <input v-model="password_confirmation" type="password" class="form-control" placeholder="Confirmar contraseña" v-on:click="deleteError('password_confirmation')">
                <small id="msn1" class="help-block result-password_confirmation" v-show="formErrors.password_confirmation"></small>
              </div>
            </div>
          </div>
          <div class="col-xs-12 col-sm-6">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default btn-sm btn-flat" data-dismiss="modal" @click="resetForm()">Cerrar</button>
          <button type="button" class="btn btn-primary btn-sm" @click.prevent="create()" v-if="editar==0">Guardar</button>
